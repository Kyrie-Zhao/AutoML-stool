...
from loss import *
from utils import read_all_batches, read_val_data
...
class Solver_Train(object):
    ...
    def pretrain(self,action):
        ...
        for epoch in range(1, self.epochs + 1): # self.epochs = 10 * (MAX_SIZE/2)
            ...
            #print("data loading")
            train_data_batch, train_label_batch = self.pretrain_get_augment_train_batch(train_data, train_label, self.train_batch_size)
    ...
    def train_coarse(self,action):
        ...
        # create placeholder
        self.img_placeholder = tf.placeholder(dtype=tf.float32,
                                              shape=[None, self.input_w, self.input_h, self.input_c],
                                              name='image_placeholder')
        self.label_placeholder = tf.placeholder(dtype=tf.int32,
                                                shape=[None],
                                                name='label_placeholder')
